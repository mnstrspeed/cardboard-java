...
public class ScreenParams {
	...
	public static ScreenParams fromProto(final Display display,
			final Phone.PhoneParams params) {
		if (params == null) {
			return null;
		}
	...
	public String toString() {
		return "{\n"
				+ new StringBuilder(22).append("  width: ").append(this.mWidth)
						.append(",\n").toString()
				+ new StringBuilder(23).append("  height: ")
						.append(this.mHeight).append(",\n").toString()
				+ new StringBuilder(39).append("  x_meters_per_pixel: ")
						.append(this.mXMetersPerPixel).append(",\n").toString()
				+ new StringBuilder(39).append("  y_meters_per_pixel: ")
						.append(this.mYMetersPerPixel).append(",\n").toString()
				+ new StringBuilder(39).append("  border_size_meters: ")
						.append(this.mBorderSizeMeters).append(",\n")
						.toString() + "}";
	}

	public static ScreenParams createFromInputStream(final Display display,
