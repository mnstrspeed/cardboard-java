...
public class FieldOfView {
	...
	public FieldOfView(final float left, final float right, final float bottom,
			final float top) {
		super();
		this.mLeft = left;
		this.mRight = right;
	...
	public void toPerspectiveMatrix(final float near, final float far,
			final float[] perspective, final int offset) {
		...
		final float b = (float) (-Math.tan(Math.toRadians(this.mBottom)))
				* near;
	...
	public String toString() {
		return "{\n"
				+ new StringBuilder(25).append("  left: ").append(this.mLeft)
						.append(",\n").toString()
				+ new StringBuilder(26).append("  right: ").append(this.mRight)
						.append(",\n").toString()
				+ new StringBuilder(27).append("  bottom: ")
						.append(this.mBottom).append(",\n").toString()
				+ new StringBuilder(24).append("  top: ").append(this.mTop)
						.append(",\n").toString() + "}";
	}
}
