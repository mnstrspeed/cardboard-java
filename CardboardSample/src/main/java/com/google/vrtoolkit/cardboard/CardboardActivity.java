...
public class CardboardActivity extends Activity {
	...
	public boolean areVolumeKeysDisabled() {
		...
		default: {
			throw new IllegalStateException(new StringBuilder(36)
					.append("Invalid volume keys mode ")
					.append(this.mVolumeKeysMode).toString());
		}
		}
	}
	...
	protected void updateCardboardDeviceParams(
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		(this.mMagnetSensor = new MagnetSensor((Context) this))
				.setOnCardboardTriggerListener(this.sensorListener);
		(this.mNfcSensor = NfcSensor.getInstance((Context) this))
				.addOnCardboardNfcListener(this.sensorListener);
		...
		if (Build.VERSION.SDK_INT < 19) {
			...
			this.getWindow()
					...
					.setOnSystemUiVisibilityChangeListener(
							(View.OnSystemUiVisibilityChangeListener) new View.OnSystemUiVisibilityChangeListener() {
	...
	public boolean onKeyDown(final int keyCode, final KeyEvent event) {
		return ((keyCode == 24 || keyCode == 25) && this
	...
	private class SensorListener implements
