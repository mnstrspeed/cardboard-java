...
public class CardboardOverlayView extends LinearLayout {
	...
	private class CardboardOverlayEyeView extends ViewGroup {
		...
		protected void onLayout(boolean changed, int left, int top, int right,
			...
			// ViewGroup.
			// We multiply both width and heading with this number to compute
			// the image's bounding
			// box. Inside the box, the image is the horizontally and vertically
			// centered.
			final float imageSize = 0.12f;

			// The fraction of this ViewGroup's height by which we shift the
			// image off the
			// ViewGroup's center. Positive values shift downwards, negative
