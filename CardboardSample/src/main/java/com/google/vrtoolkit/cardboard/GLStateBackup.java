...
class GLStateBackup {
	...
	void readFromGL() {
		...
		GLES20.glGetIntegerv(GLES20.GL_ARRAY_BUFFER_BINDING,
				this.mArrayBufferBinding);
		GLES20.glGetIntegerv(GLES20.GL_ELEMENT_ARRAY_BUFFER_BINDING,
	...
	void writeToGL() {
		...
		GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER,
				this.mArrayBufferBinding.array()[0]);
		GLES20.glBindBuffer(GLES20.GL_ELEMENT_ARRAY_BUFFER,
				this.mElementArrayBufferBinding.array()[0]);
		GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, this.mTexture2dId.array()[0]);
		GLES20.glActiveTexture(this.mTextureUnit.array()[0]);
		GLES20.glScissor(this.mScissorBox.array()[0],
				this.mScissorBox.array()[1], this.mScissorBox.array()[2],
				this.mScissorBox.array()[3]);
		GLES20.glUseProgram(this.mShaderProgram.array()[0]);
		GLES20.glClearColor(this.mClearColor.array()[0],
				this.mClearColor.array()[1], this.mClearColor.array()[2],
				this.mClearColor.array()[3]);
	...
	private class VertexAttributeState {
		...
		void readFromGL() {
			GLES20.glGetVertexAttribiv(this.mAttributeId,
					GLES20.GL_VERTEX_ATTRIB_ARRAY_ENABLED, this.mEnabled);
		}
